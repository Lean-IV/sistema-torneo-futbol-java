...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			sys.agregarJugador("Franck", "Ribéry", "10896468", LocalDate.of(1974, 4, 7), 1.68, 67, "Delantero", 7); // id:4
			sys.agregarJugador("Joaquin", "Acosta", "10891458", LocalDate.of(1983, 4, 7), 1.68, 67, "Delantero", 7);
			sys.agregarJugador("Leandro", "Norris", "10894468", LocalDate.of(1988, 4, 7), 1.68, 67, "Delantero", 7);
			sys.agregarJugador("Ivan", "Nadal", "10896467", LocalDate.of(1990, 4, 7), 1.68, 67, "Delantero", 7);
			sys.agregarJugador("Franco", "Federer", "10891468", LocalDate.of(1983, 4, 7), 1.68, 67, "Delantero", 7);
			sys.agregarJugador("Gustavo", "Djokovic", "10876468", LocalDate.of(2000, 4, 7), 1.68, 67, "Delantero", 7);
			...
			sys.agregarEquipo("Boca", LocalDate.of(1905, 4, 3), sys.traerEntrenadorId(3));
			sys.agregarEquipo("River", LocalDate.of(1901, 5, 25), sys.traerEntrenadorId(4));
			sys.agregarEquipo("Racing", LocalDate.of(1903, 3, 25), sys.traerEntrenadorId(1));
			sys.agregarEquipo("San Lorenzo", LocalDate.of(1908, 4, 1), sys.traerEntrenadorId(2));
			sys.agregarEquipo("Independiente", LocalDate.of(1905, 1, 1), sys.traerEntrenadorId(3));
			sys.agregarEquipo("Temperley", LocalDate.of(1912, 11, 1), sys.traerEntrenadorId(4));
			
			
			//Agrego jugadores(dni) a equipo (id)
			...
			System.out.println("LISTA GANADORES:"); //CU 4
			System.out.println(sys.generarGanadores(1, LocalDate.of(1954, 1, 25))); 
			
			System.out.println("LISTA TACTICA PREFERIDA:"); //CU5
			System.out.println(sys.listaTacticaPreferida("Defensivo"));
			
			System.out.println("LISTA FECHA NACIMIENTO:");//CU6
			System.out.println(sys.listaPorFechaNacimiento(LocalDate.of(1990, 1, 25), LocalDate.of(2000, 1, 25)));

			System.out.println("LISTA EQUIPOS FUNDADOS ANTES QUE: "+ LocalDate.of(1901, 1, 1).toString()); //CU7
			System.out.println(sys.equiposFundadosAntesQue(LocalDate.of(1901, 1, 1)));
			
			System.out.println("ALTURA PROMEDIO DE BANFIELD:"); //CU8
			System.out.println(sys.calcularPromedioAlturaEquipo(2));

			System.out.println("EQUIPO CON MAYOR ALTURA DEL TORNEO:");//CU9
			System.out.println(sys.equipoConMayorAlturaPromedio(1));
			
			System.out.println("TABLA DE POSICIONES:");//CU11
			System.out.println(sys.generarTablaPosiciones(1));
